...
def main(
    ...
    exp_settings = f"eval_{name_data}_{objective}_{prior_type}_{kl_penalty}.pt"
    ...
    dir_net1 = f"./saved_models/net1_" + exp_settings
    ...
    dir_net2 = f"./saved_models/net2_" + exp_settings
